...
export class AppService {
	...
	async get24HrBinance(): Promise<any> {
		try{
			...
			console.log('get24Hr ERROR: ', err);
			throw new InternalServerErrorException('We are syncing our database with binance, please try again in a few min :)');
		}
	}
}
